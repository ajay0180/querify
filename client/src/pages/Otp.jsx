...
export default function Otp() {
  ...
  return (
    <div className="bg-[#ebecee] h-[100vh] w-full flex flex-row">
      <form
        onSubmit={formSubmit}
        className="w-[800px]  bg-[#fff] md:rounded-tr-xl md:rounded-br-xl flex items-start justify-center relative"
      >
      ...
      <div className="otp-right relative flex gap-3 flex-col items-center bg-[#191919]  justify-center w-0 md:w-[45%] overflow-hidden bg-cover bg-center no-repeat">
        <div className=" text-center flex flex-start ">
          <img
            className="text-white text-[1.8rem]  translate-x-[-90px]"
            src={OtpImg}
            style={{ filter: "drop-shadow(5px 5px 5px #876e35)" }}
          />
        </div>
      </div>
    </div>
