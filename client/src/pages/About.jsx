...
export default function About() {
  ...
  useEffect(() => {
    ...
    document.querySelector("#vidBtn").addEventListener("mouseover", () => {
      gsap.to("#vid", {
        opacity: 1,
        duration: 1,
        ease: "power3",
    ...
    document.querySelector("#vidBtn").addEventListener("mouseleave", () => {
      gsap.to("#vid", {
        opacity: 0,
        duration: 1,
        ease: "power3",
  ...
  return (
    <div>
      ...
      <div className="vid-cursor rotate-90 fixed scale-0  h-[80px] w-[80px] translate-x-[-50%] translate-y-[-50%] pointer-events-none z-[10] rounded-full bg-black text-white flex justify-center items-center">
        Signup
      </div>
      ...
      >
        ...
        >
          <div
            ref={scrollerRef}
            className="h-max scrollerContainer"
            data-scroll-section
          >
            <div id="a_home" className="">
              ...
              <div className="a_navbar">
                ...
                <div className="w-full lg:flex hidden h-[50px]  justify-center items-center ">
                  <div className="h-max w-max flex text-[13px] gap-[85px]">
                    <div
                      className="nav_item cursor-pointer hover:text-gray-500 transition-all duration-200 relative top-[10px] opacity-0"
                      onClick={() => navigate("/")}
                    >
                      Home
                    </div>
                    <div className="nav_item cursor-pointer hover:text-gray-500 transition-all duration-200 relative top-[10px] opacity-0">
                      Solutions
                    </div>
                    <div className="nav_item cursor-pointer hover:text-gray-500 transition-all duration-200 relative top-[10px] opacity-0">
                      Templates
              ...
              <div
                id="a_hero"
                className="w-full h-max mt-[14vw] py-[3vw] px-[10vw] flex justify-between items-center "
              >
                <div className="anim2 hero_1 w-[200px] max-h-[450px] overflow-hidden">
                  ...
                  <p className="text-[12px] w-[95%] capitalize my-[10px]  tracking-wide text-[#5e5e5e] leading-[15px]">
                    Discover the quiet elegance of Inquiry Insights.
                  </p>
                  <div className="image-wrapper w-[85%] h-[270px] ">
                    <img
                      src={aboutImgSmall}
                      className="w-full imgAnim2 h-[95%] object-cover"
                      alt="img1"
                    />
                  </div>
                </div>
                ...
                <div className="hero_2 w-[30vw] max-h-max   relative ">
                  <div className="a_headings leading-[70px] absolute top-[-17%] left-[-10%] z-[99]">
                    <h1 className="text-[5vw] tracking-[-0.17vw] font-[200]">
                      Questionnaire{" "}
                    </h1>
                    <h1 className="text-[5vw] tracking-[-0.17vw] font-[200]">
                      Splendor.
                  ...
                  <div className="anim2 imgAnim2">
                    <video
                      src={aboutVid1}
                      className=" w-[100%] object-left relative h-[550px] object-cover"
                      autoPlay={true}
                      muted={true}
                      loop={true}
                      style={{ opacity: 1 }}
                    ...
                    <p className="max-w-[48%]  text-[15px] font-semibold my-3">
                      Embark on journey of Subtle Elegance of Profound Inquiry
                      Insights.
                    </p>
                  </div>
                </div>
                ...
                <div
                  id="visit"
                  className="anim2 hero_3 flex gap-[10px] items-center "
                >
                  <div
                    id="circlev"
                    className="w-[3vw] h-[3vw] rounded-full border border-[#5e5e5e] flex items-center justify-center"
                  >
              ...
              <div className=" about min-h-[65vh] w-full  flex flex-col  items-center overlfow-hidden  motive px-[3vw] py-[3vw] my-6  gap-[30px] relative">
                ...
                <div className="min-h-full min-w-full relative">
                  <motion.div className="w-full text-left absolute top-0 left-0  overflow-hidden leading-[83px] mt-[30px]">
                    <motion.p
                      className=" z-[2] text-[62px] whitespace-nowrap overflow-hidden tracking-tight "
                      whileInView={{ y: 0, opacity: 1 }}
                      initial={{ y: 50, opacity: 0 }}
                      transition={{ delay: 1, damping: 50 }}
                    >
                      {" "}
                      Craft captivating surveys effortlessly.
                    </motion.p>
                    <motion.p
                      className=" text-[62px] whitespace-nowrap overflow-hidden tracking-tight "
                      whileInView={{ y: 0, opacity: 1 }}
                      initial={{ y: 50, opacity: 0 }}
                      transition={{ delay: 1, damping: 50 }}
                    >
                      {" "}
                      Your hub for captivating surveys and forms.
                    </motion.p>
                    <motion.p
                      className=" text-[62px] whitespace-nowrap overflow-hidden tracking-tight  "
                      whileInView={{ y: 0, opacity: 1 }}
                    ...
                    >
                      {" "}
                      Create dynamic, experiences effortlessly.
                    </motion.p>
                    <motion.p
                      className=" text-[62px] whitespace-nowrap overflow-hidden tracking-tight "
                      whileInView={{ y: 0, opacity: 1 }}
                    ...
                    >
                      {" "}
                      Revolutionize data with seamless customization.
                    </motion.p>
                    <motion.p
                      className=" text-[62px] whitespace-nowrap overflow-hidden tracking-tigth  "
                      whileInView={{ y: 0, opacity: 1 }}
                      initial={{ y: 50, opacity: 0 }}
                      transition={{ delay: 1, damping: 50 }}
                    >
                      {" "}
                      Transform data with effortless customization
                    </motion.p>
                  </motion.div>
                </div>
              </div>
            ...
            <div className="vid-section h-screen  w-full relative flex items-center justify-center">
              ...
              />
              <svg
                class="abs tl:0 fit transform rotate:-90deg absolute w-[35%]"
                viewBox="0 0 100 100"
              >
                <circle
                  cx="50"
                  ...
                  stroke-width="0.25"
                  fill="none"
                  class="o:0.3 $$2$$ $$3$$ $$4$$ (.in-view):tween:all,2.8s,easeOutSlow dasharray:308 dashoffset:616 (.in-view):dashoffset:492.8"
                ></circle>
                <circle
                  cx="50"
                  cy="50"
                  ...
                  stroke-width="0.25"
                  fill="none"
                  class="$$5$$ $$6$$ $$7$$ (.in-view):tween:all,2.8s,easeOutSlow dasharray:308 dashoffset:308 (.in-view):dashoffset:184.79999999999998"
                ></circle>
              </svg>
              <div className="w-[35%] absolute animate-pulse duration-500">
                <svg
                  class="abs tl:0 fit transform rotate:0 $$8$$ (.in-view):tween:all,2.8s,easeOutSlow (.in-view):rotate:144deg"
                  viewBox="0 0 100 100"
                >
            ...
            <div className=" about min-h-[45vh] w-full items-end  flex flex-col   overlfow-hidden  motive px-[3vw] gap-[30px] relative">
              ...
              <div className="min-h-full min-w-full relative">
                <motion.div className="w-full text-left absolute top-0 left-0  overflow-hidden leading-[83px] mt-[30px]">
                  <motion.p
                    className=" text-[62px] whitespace-nowrap overflow-hidden tracking-tight text-right"
                    whileInView={{ y: 0, opacity: 1 }}
                    initial={{ y: 50, opacity: 0 }}
                  ...
                  >
                    {" "}
                    Revolutionize your data management with ease.
                  </motion.p>
                </motion.div>
              </div>
            </div>
            ...
            <div className="pictures px-[5vw] py-[3vw] flex mt-[10vh] relative">
              <div className="blurCont absolute w-full h-full translate-x-[15%] translate-y-[45%] z-[10]">
                <div className="blurItem-1 absolute right-0  w-[400px]  h-[400px] bg-[#03618f] blur-[30px] rounded-full  bottom-[-50%]" />
                <div className="blurItem-2 absolute w-[400px]  h-[400px] bg-[#03618f] blur-[30px] rounded-full right-0  bottom-[-50%]" />
              </div>
              ...
              >
                <div className=" w-[30vw] h-[30vw] mb-[1vw] flex items-center justify-center">
                  <img
                    src={aboutImg6}
                    alt="img"
                    className="w-full h-full imgAnim1 object-contain object-center"
                  />
                </div>
                ...
                <div className=" w-[30vw] h-[30vw] mb-[1vw]  flex items-center justify-center">
                  <img
                    src={aboutImg8}
                    alt="img"
                    className="w-full h-full imgAnim1 object-cover object-center"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="future w-full h-[100vh] bg-[#fafafa] flex items-center justify-center flex-col relative">
              <video
                ...
                loop={true}
                playsInline={true}
                className="opacity-0 min-h-full min-w-full object-cover"
              />
