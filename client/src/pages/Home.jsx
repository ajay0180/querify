  ...
  useEffect(() => {
    ...
    refMain.current.addEventListener("scroll", () => {
      animateVideo(
        refTrigger2.current,
        refVideo.current,
        refTextHeaderLeft.current,
        refTextHeaderRight.current
      );
      scrollBlogPosts(refBlogSection.current, [
        refBlogImage0.current,
        refBlogImage1.current,
        refBlogImage2.current,
      ]);
          ...
          <div className="scroll_container" data-scroll-section>
                ...
                <div className="w-full flex justify-center items-center">
                  <div className="w-[30%] gap-[10px] flex justify-between overflow-x-visible">
                    <div
                      ...
                      className=" hero_cta text-[2rem] flex items-baseline cursor-pointer px-2   transition-all duration-500  rounded-full relative"
                    ...
                    <div
                      ...
                      className=" hero_cta text-[2rem] flex justify-self-end items-baseline cursor-pointer px-2 transition-all duration-500  rounded-full relative"
            ...
            <section id="about">
              <div className="about_container">
                <div className="about_text">
                  <p ref={refSecTwoText} className="text-[#0000006a]">
                    Elevate your surveying experience with Querify. Our platform
                    offers a wide range of professionally crafted forms across
                    all categories. From customer feedback to event polls,
                    Querify provides intuitive tools to create impactful surveys
                    effortlessly. Join us to unlock valuable insights and drive
            ...
            <section ref={refTrigger2} id="video">
              ...
              <div ref={refTrigger} className="video_sticky">
                ...
                <div className="video_text_overlay ">
                  <h2
                    ref={refTextHeaderLeft}
                    className="text_header_left text-[180px]"
                  >
                    SURVEY
                  </h2>
                  <h2
                    ref={refTextHeaderRight}
                    className="text_header_right text-[180px]"
                  >
                    FUTURE
                  </h2>
                </div>
                      ...
                      <div className={`project ${project.pos}`}>
                        <div className="image_container h-[250px] w-[320px] rounded-lg shadow-md">
                          <img
                            src={project.image}
                            alt={`img_${idx}`}
                            className="project_image h-[250px] w-[320px] object-cover"
                          />
                        </div>
                ...
                <div ref={refBlogImage0} className="post">
                  <div className="post_image_container">
                    <img
                      src={home9}
                      alt="blogImg"
                      className="blog_post_image backdrop-brightness-75"
                    />
                  </div>
                </div>
              </div>
            ...
            <section ref={refCircleSection} id="circle_section">
              <div className="circle_sticky">
                ...
                <div className="circle_container">
                  <div ref={refCircle} className="circle_home"></div>
                </div>
              </div>
            </section>
            ...
            <section id="discover">
              <div ref={refDiscoverContainer} className="discover_container">
                <p ref={refDiscoverTextLeft} className="text_left">
                  THIS SITE WAS DESIGNED BY QUERIFIER COMMUNITY
                </p>
                <p ref={refDiscoverTextRight} className="text_right">
                  LET'S SURVEY THE FUTURE TOGETHER
                </p>
            ...
            <section id="end_video">
              ...
              <div className="end_video_container">
                <video
                  className="end_video brightness-75"
                  autoPlay={true}
                  muted={true}
                  loop={true}
                  playsInline={true}
