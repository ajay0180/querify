...
export default function  Range({que,idx}){
    ...
    return (
        ...
        :
        <div className="h-full w-full flex flex-col relative que mb-3  transition-all duration-100 ">
            ...
            >{
                ...
                <textarea 
                    type="text"
                    className="border w-full h-max  rounded-md bg-slate-200"
            ...
            <div className="w-[50%] min-w-[250px] mt-7">
                ...
                <input
                    ...
                    style={{borderColor:visualData.buttonColor, fontFamily:visualData.fontFamily}}
                />
                <div 
                ...
                >
                    {
                        arr.map((val, idx)=>(
                            ...
                            <span className="text-sm" key={idx}  style={{color:visualData.queColor, fontFamily:visualData.fontFamily}}>{val}</span>
                        ))
                    }
